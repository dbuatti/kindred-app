          ...
          {data.nodes.map((node: any) => {
            ...
            return (
              <motion.div
                ...
                className="absolute bg-white rounded-full border border-stone-100 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.1)] hover:shadow-[0_20px_50px_-15px_rgba(0,0,0,0.15)] hover:border-amber-200 transition-all p-3 flex items-center gap-4 cursor-pointer group z-20"
              >
                <SmartSuggestionHover personId={node.id} />
                
                <div className="h-14 w-14 rounded-full overflow-hidden bg-stone-50 shrink-0 border-2 border-white shadow-md ring-1 ring-stone-100 group-hover:ring-amber-200 transition-all">
                  {hasRealPhoto ? (
