      ...
      <main className="max-w-4xl mx-auto px-6 py-12 space-y-10">
        ...
        <Card className="p-8 bg-white border-stone-100 shadow-sm rounded-[3rem] space-y-6">
          <div className="flex items-center justify-between">
            ...
            <p className="text-stone-400 text-xs italic">Stories per person</p>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-4">
            {Object.values(profiles).map((profile: any) => (
              <Card key={profile.id} className="p-6 bg-white border-stone-100 shadow-sm rounded-3xl flex items-center justify-between">
                <div className="flex items-center gap-4">
