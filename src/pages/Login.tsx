...
import { Heart, Mail, ArrowRight, Loader2, AlertCircle, Github } from 'lucide-react';
            ...
            <div className="bg-white p-10 rounded-[3rem] shadow-sm border border-stone-100 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Button 
                  ...
                  className="h-14 border-2 border-stone-100 rounded-2xl text-lg font-medium flex items-center justify-center gap-3 hover:bg-stone-50"
                >
